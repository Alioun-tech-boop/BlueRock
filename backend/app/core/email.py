...
def send_notification_email(to: str, title: str, body: str) -> bool:
    """Alerte de suivi du plan (in-app → email)."""
    html_body = f"{body}<br/><br/><a href=\"{settings.FRONTEND_URL}/portfolio\" " \
                f"style=\"color:#00C853;text-decoration:none;font-weight:700\">Ouvrir mon portefeuille &rarr;</a>"
    html = _layout(title, html_body, "BlueRock — Suivi quotidien de votre plan")
