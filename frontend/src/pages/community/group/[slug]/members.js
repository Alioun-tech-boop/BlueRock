...
export default function CommunityGroupMembersPage() {
  ...
  const openUser = (id) => router.push(`/community/user/${id}`)
  ...
  return (
    <div className="co-doc">
      <header className="co-doc-bar">
        ...
        <h1 className="co-doc-title">{t(lang, 'grpMembersTitle')}</h1>
      ...
      <div className="co-doc-col">
        {slug ? <GroupMembersView slug={slug} lang={lang} onOpenUser={openUser} /> : null}
      </div>
